...
public:
    ...
    virtual void AnimateObjects(float fTimeElapsed,XMFLOAT3 pos);
    virtual void Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera=NULL);

	virtual void ReleaseUploadBuffers();

	void SetPlayer_Position(CPlayer* player);
public:
	...
	CShader								**m_ppBillboardShaders = NULL;
	...
	int									m_nTower = 0;
	CTowerObject						*m_pTower = NULL;
	CGameObject							**m_pTObjects = 0;
	int									m_TObjects = 0;
...
class MainCScene : public CScene
{
public:
	MainCScene();
	~MainCScene();
...
class MenuCScene : public CScene
{
public:
	MenuCScene();
	~MenuCScene();
