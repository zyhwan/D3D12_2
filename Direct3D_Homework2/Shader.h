...
public:
	...
	//주인공 객체정보
	virtual void SetPlayer(CPlayer* m_pPlayer) { pPlayer = m_pPlayer; };
...
public:
	...
	void CheckEnemyByBulletCollisions();  //총알과 적 충돌
...
class CTowerShader : public CShader
{
public:
	CTowerShader();
	virtual ~CTowerShader();
